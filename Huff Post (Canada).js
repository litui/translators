{
	"translatorID": "e8167ea0-fb49-4671-9ceb-c12467cf01cc",
	"label": "Huff Post (Canada)",
	"creator": "Aria Ehren",
	"target": "^https?://(www|search)\\.huffingtonpost\\.ca",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	"translatorType": 4,
	"browserSupport": "gcsv",
	"lastUpdated": "2016-03-26 02:30:56"
}
...
publicationTitle : "Huffington Post Canada"
});
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/huffingtonpost.ca\/search\.php/),
choices          : {
...
var testCases = [
	{
		"type": "web",
		"url": "http://www.huffingtonpost.ca/business/",
		"items": "multiple"
	},
	{
		"type": "web",
		"url": "http://www.huffingtonpost.ca/brian-dijkema/predatory-lending_b_9540824.html?ref=canada-business",
		"items": [
			{
				"itemType": "blogPost",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.huffingtonpost.ca/2011/11/28/prepaid-cards_n_1117226.html?ref=business",
		"items": [
			{
				"itemType": "webpage",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.huffingtonpost.ca/search.php/?q=labor+market&s_it=header_form_v1",
		"items": "multiple"
	}
]
/** END TEST CASES **/